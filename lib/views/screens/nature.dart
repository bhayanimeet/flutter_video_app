...
class _NatureState extends State<Nature> {
  ...
  Future<void> loadVideo1() async {
    videoPlayerController1 = VideoPlayerController.asset('assets/videos/nature1.mp4');
  ...
  Future<void> loadVideo2() async {
    videoPlayerController2 = VideoPlayerController.asset('assets/videos/nature2.mp4');
  ...
  Future<void> loadVideo3() async {
    videoPlayerController3 = VideoPlayerController.asset('assets/videos/nature3.mp4');
  ...
  Future<void> loadVideo4() async {
    videoPlayerController4 = VideoPlayerController.asset('assets/videos/nature4.mp4');
  ...
  Future<void> loadVideo5() async {
    videoPlayerController5 = VideoPlayerController.asset('assets/videos/nature5.mp4');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Nature Videos"),
        centerTitle: true,
      ),
      body: Center(
        child: Column(

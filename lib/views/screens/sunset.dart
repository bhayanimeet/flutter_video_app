...
class _SunsetState extends State<Sunset> {
  ...
  Future<void> loadVideo1() async {
    videoPlayerController1 = VideoPlayerController.asset('assets/videos/sunset1.mp4');
  ...
  Future<void> loadVideo2() async {
    videoPlayerController2 = VideoPlayerController.asset('assets/videos/sunset2.mp4');
  ...
  Future<void> loadVideo3() async {
    videoPlayerController3 = VideoPlayerController.asset('assets/videos/sunset3.mp4');
  ...
  Future<void> loadVideo4() async {
    videoPlayerController4 = VideoPlayerController.asset('assets/videos/sunset4.mp4');
  ...
  Future<void> loadVideo5() async {
    videoPlayerController5 = VideoPlayerController.asset('assets/videos/sunset5.mp4');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Sunset Videos"),
        centerTitle: true,
      ),
      body: Center(
        child: Column(
